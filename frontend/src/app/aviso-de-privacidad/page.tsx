          ...
          <div className="bg-white p-8 rounded-lg shadow-sm">
            <div className="prose prose-lg max-w-none">
              <p>
                ...
                con domicilio en Córdoba 42, Piso 11, Colonia Roma Norte, Delegación Cuauhtémoc,
                C.P. 06700, Ciudad de México, es responsable del tratamiento de sus datos personales.
              </p>
              ...
              <p>
                ...
                a través del siguiente medio: enviando un correo electrónico a <span className="text-eqhuma-primary">privacidad@eqhuma.mx</span>
              </p>
              ...
              <p>
                ...
                siguientes medios: enviando un correo electrónico a <span className="text-eqhuma-primary">privacidad@eqhuma.mx</span>
              </p>
              ...
              <p>
                ...
                a través de nuestro sitio web: <span className="text-eqhuma-primary">www.eqhuma.mx</span>
              </p>
